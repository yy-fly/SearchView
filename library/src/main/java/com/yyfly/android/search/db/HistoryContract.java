package com.yyfly.android.search.db;
...
public class HistoryContract {
    ...
    private static String initAuthority() {
        String authority = "com.yyfly.android.search.default_search_history_database";

//        try {
//            ClassLoader clazzLoader = HistoryContract.class.getClassLoader();
//            Class<?> clazz = clazzLoader.loadClass("com.yyfly.android.search.MsvAuthority");
...
//        }
    ...
    public static final class HistoryEntry implements BaseColumns {
        ...
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/" + CONTENT_URI + "/" + PATH_HISTORY;

        public static final String CONTENT_ITEM = "vnd.android.cursor.item/" + CONTENT_URI + "/" + PATH_HISTORY;
